			...
			<table className="min-w-full border border-gray-300 ">
				<thead className="bg-gray-100">
					<tr>
						...
						<th className="py-2 px-4 border text-left border-gray-300">Team</th>
						<th className="py-2 px-4 border border-gray-300">Played</th>
						<th className="py-2 px-4 border border-gray-300">Won</th>
						<th className="py-2 px-4 border border-gray-300">Draw</th>
						<th className="py-2 px-4 border border-gray-300">Lost</th>
						<th className="py-2 px-4 border border-gray-300">GD</th>
						<th className="py-2 px-4 border border-gray-300 ">Points</th>
					</tr>
				</thead>
				<tbody>
					{standings.map((team) => (
						<tr
							...
							onClick={() =>
								setViewState({ view: "teamView", teamView: team.team })
							}
						>
